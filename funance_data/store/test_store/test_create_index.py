...
class TestCreateIndex(StoreTestCase):
    def test_does_not_exist(self) -> None:
        ...
        self.mock_client.indices.exists.assert_called_once_with(index=self.store.get_index_name())
        self.mock_client.indices.create.assert_called_once_with(index=self.store.get_index_name())
